...
Ext.define('TaskManager.controller.Upload', {
    ...
    onMultiFileSelected: function(field, newValue, oldValue, eOpts) {
        ...
        var rqtWin = selectedFilesCon.up('window');
        var newRqt = rqtWin.down('newrequest');
        var infos = [];
        // var dsetGrid = rqtWin.down('datasetgridbox').getGrid();
        // if(dsetGrid.getStore().getCount() == 1 && !newRqt.isEditMode){
        //     dsetGrid.getStore().removeAll();
        // }
        ...
        //     var designName = entry.name.split('.')[0];
        //     var emptyData = {subIdx:'', cols27_data_0103:designName};
        //     dsetGrid.getStore().add(emptyData);
        });
        if(!grid){
