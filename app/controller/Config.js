...
Ext.define('TaskManager.controller.Config', {
    extend: 'Ext.app.Controller',

    setShortcuts: function(userShortcuts) {
        var me = this;
    ...
    createShortcut: function(scWin, scInfo) {
        var me = this;
        var shortcutCon = scWin.down('#selectedCon');
    ...
    getShortcutIcons: function(target) {
    ...
    editShortcutTitle: function(target) {
