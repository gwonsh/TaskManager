...
Ext.define('TaskManager.controller.Main', {
    ...
    onBtnConfigClick: function(button, e, eOpts) {
        var me = this;
    ...
    createNewGrid: function(cId, title, gridType, tabIndex) {
        var me = this;
    ...
    setMenuPermission: function(categoryInfo) {
